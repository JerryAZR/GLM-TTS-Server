...
class Token2Wav:
    def __init__(self, flow, sample_rate: int = 24000, device: str = "cuda", model_dir: str = "ckpt"):
        self.device = device
        self.flow = flow
        ...
        if sample_rate == 32000:
            ...
            self.vocoder = load_vocos_jit(device, model_dir=model_dir)
        elif sample_rate == 24000:
            self.hop_size = 480
            self.sample_rate = 24000
            self.vocoder = load_hift(device, model_dir=model_dir)
        else:
